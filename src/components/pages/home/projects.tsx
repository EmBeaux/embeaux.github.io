                ...
                slides={[
                    {
                        ...
                        content: (
                            <ProjectCard
                                ...
                                image={window.location.origin + '/arrow.gif'}
                    ...
                    },
                    {
                        ...
                        content: (
                            <ProjectCard
                                ...
                                image={window.location.origin + '/telenursing.png'}
                    ...
                    },
                    {
                        ...
                        content: (
                            <ProjectCard
                                ...
                                image={window.location.origin + '/censinet.webp'}
                    ...
                    },
                    {
                        ...
                        content: (
                            <ProjectCard
                                ...
                                image={window.location.origin + '/unity.svg'}
